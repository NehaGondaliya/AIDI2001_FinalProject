...
from brainofthedoctor import encode_image, analyze_image_with_query
from voiceofthepatient import record_audio, transcribe_with_groq
from voiceofthedoctor import text_to_speech_with_gtts
...
iface = gr.Interface(
    ...
    title="DocTalk- The future of AI power consultation."
)
